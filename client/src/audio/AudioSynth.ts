...
export class AudioSynth {
  ...
  _volume: number = 32768;


  static readonly _noteMap: Map<string, number> = new Map<string, number>([
    ['C', 261.63],
    ['C#', 277.18],
    ['D', 293.66],
    ['D#', 311.13],
  ...
  static readonly _notes: Array<string> = Array.from(AudioSynth._noteMap.keys());
